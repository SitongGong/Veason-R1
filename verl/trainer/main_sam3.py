...
from verl.trainer.ray_trainer_sam3 import RayPPOTrainer, ResourcePoolManager, Role
from verl.utils import get_processor, get_tokenizer
from verl.workers.fsdp_workers_sam3 import FSDPWorker
...
def main():
    ...
    if not ray.is_initialized():
        ...
        ray.init(runtime_env={"env_vars": {"TOKENIZERS_PARALLELISM": "true", "NCCL_DEBUG": "WARN"}}, num_cpus=16)
...
def main_task(config: PPOConfig):
    ...
    trainer.init_workers(mode=config.data.sam3_mode)
    trainer.fit()
