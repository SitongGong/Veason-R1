...
class DataConfig:
    ...
    system_prompt_path: Optional[str] = None # 增加
    shuffle: bool = True
    seed: int = 1
    max_pixels: int = 4194304
    min_pixels: int = 262144
    keyframe_resize: int = 840
    reference_image_resize: int = 840
    sam3_mode: str = "images"
    sam2_mode: str = "video"
    sampled_frames: int = 6
    use_text_prompt: bool = False # 增加
    gpus_to_use: str = "0" # 增加
