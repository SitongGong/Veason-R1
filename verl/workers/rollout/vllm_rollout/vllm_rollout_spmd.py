...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if "images" in non_tensor_batch:
            vllm_inputs = []
            non_tensor_images = non_tensor_batch.pop("images")
            for raw_prompt_ids, images in zip(non_tensor_batch.pop("raw_prompt_ids"), non_tensor_images):
        ...
        # users can customize different sampling_params at different run   生成多种采样的答案
        ...
        non_tensor_batch["images"] = _repeat_interleave(non_tensor_images, self.config.n)
