...
def vision_reasoner_seg_reward(predict_str: str, gt_mask: torch.Tensor=None, seg_model=None, keyframe_id=None, ):
    max_accuracy_reward = 0.0
...
def video_match_seg_compute_score(predict_str: str, ground_truth: str, gt_mask: torch.Tensor=None, seg_model=None, keyframe_id=None, images=None) -> float:
    ...
    # seg_reward = vision_reasoner_seg_reward(predict_str, gt_mask, seg_model, keyframe_id)
