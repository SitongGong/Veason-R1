...
def vision_reasoner_accuracy_reward(predict_str: str, ground_truth: str, gt_mask: torch.Tensor=None, seg_model=None, images=None, frame_ids=None) -> float:
    ...
    try:
        ...
        pass
    return avg_iou_reward    # + max_accuracy_reward


def ablation_keyframe_sft_only_sam_mod_compute_score(predict_str: str, ground_truth: str, gt_mask: torch.Tensor=None, seg_model=None, keyframe_id=None, images=None, frame_ids=None) -> float:
    ...
    reward = format_reward + accuracy_reward + keyframe_reward
    return reward