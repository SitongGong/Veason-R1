...
def ablation_keyframe_sft_only_external_compute_score(predict_str: str, ground_truth: str, gt_mask: torch.Tensor=None, seg_model=None, keyframe_id=None, images=None, frame_ids=None) -> float:
    ...
    reward = format_reward + keyframe_reward + seg_reward
    return reward