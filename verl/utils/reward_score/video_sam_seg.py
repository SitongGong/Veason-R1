...
def seg_mask_reward(predict_str: str, ground_truth: str, gt_mask: torch.Tensor, seg_model=None, keyframe_id=None, images=None) -> float:
    ...
    try:
        ...
        if json_match:
            ...
            iou = compute_iou(masks[0], gt_mask[keyframe_id])
...
def video_seg_strict_compute_score_sam2(predict_str: str, ground_truth: str, gt_mask: torch.Tensor=None, seg_model=None, keyframe_id=None, images=None) -> float:
    ...
    reward = iou_reward + thinking_format_reward + segmentation_format_reward + mask_reward
    return reward