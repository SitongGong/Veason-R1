...
class ReVOSDataset(Dataset):
    ...
    def __init__(
        ...
        self.user_prompt = "Keyframe: <image> " \
                           ...
                           "Given the reference video frames, please identify '{Question}' and respond with its bounding box and points in the keyframe." \
                           "Analyze the reference video frames to understand the video context and focus on any patterns or information that could help identify the target." + \
                           "Compare the difference between objects in the keyframe and find the most closely matched one." \
