...
class ReVOSDataset(Dataset):
    ...
    def __init__(
        ...
        self.user_prompt = "Keyframe: <image> " \
                           ...
                           "Output the only one bbox and points of two largest inscribed circles inside the interested object in JSON format." \
    ...
    def __getitem__(self, index):
        ...
        messages = [
            ...
            {"role": "user", "content": user_prompt.format(Question=exp.lower().strip("."),
                                                           Answer="{'bbox': [x1,y1,x2,y2], 'points_1': [30,110], 'points_2': [35,180]}")},
        ]
        ################ Old Version ################
