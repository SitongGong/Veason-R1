...
class ReVOS_KeyframeSFT_Base_Dataset_Prompt(Dataset):
    """
    ...
    def __init__(
        ...
        self.user_prompt =  "<video> " + "\n" + \
                            "You are given {num} frames uniformly sampled from a 1 FPS video. Each image is preceded by a timestamp starting from 0, in sequential order according to its appearance." + "\n" + \
    ...
    def __getitem__(self, index):
        ...
        replace_sent = ", ".join(f'Frame at timestamp {i}s: <image>' for i in range(video_len))
