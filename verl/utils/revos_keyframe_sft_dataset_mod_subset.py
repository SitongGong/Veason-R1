...
class ReVOS_KeyframeSFT_Base_Dataset_mod_subset(Dataset):
    """
    ...
    def __init__(
        ...
        train_json_path = os.path.join(data_path, "meta_expressions_train_select_subset.json")
